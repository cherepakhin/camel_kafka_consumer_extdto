...
import ru.perm.v.camel.kafka.consumer_extdto.service.processor.ProcessorString
...
class ReceiverSamplesTopic: RouteBuilder() {
    ...
    override fun configure() {
        from("kafka:$TOPIC?brokers=$KAFKA_HOST")
            ...
            .bean(ProcessorString::class.java, "process") // seng to ProcessorStringBean.process(string)
